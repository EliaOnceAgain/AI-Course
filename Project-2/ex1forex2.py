...
class UtilsActions():
    @staticmethod
    def good_cop_bad_cop(current_name, current_coordinates, state, grid_size, distances_directions, undo_actions_dict):
        ...
        for dist, dirc in distances_directions:
            ...
            if new_coordinates:
                temp_move_actions_set.add(("move", current_name, current_coordinates, new_coordinates))
    ...
    def get_move_action_priority_calibration(current_estimate, undo_actions_dict, state, grid_size):
        ...
        move_actions_set.update(
            UtilsActions.good_cop_bad_cop(current_name, current_coordinates, state, grid_size, distances_directions,
                                          undo_actions_dict))
...
class Overview():
    ...
    def set_number_of_transmitters(self, number_of_transmitters):
        if number_of_transmitters < 0:
            print("DELETE ME: Warning.. Negative number of transmitters given.")
        self.num_of_transmitters = number_of_transmitters
